...
const Hero = () => {
  return (
    <div className="relative overflow-hidden bg-no-repeat bg-cover" style={{
      backgroundImage: "url('https://images.unsplash.com/photo-1548484352-ea579e5233a8?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb')",
      height: "90vh",
      ...
      <div className="container mx-auto px-4 relative h-full flex flex-col justify-center items-center text-center text-white">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-4 mb-6">
            <div className="flex items-center justify-center bg-white/20 px-4 py-2 rounded-full">
